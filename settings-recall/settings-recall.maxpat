...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 301.0, 207.0, 240.0, 20.0 ],
					"text" : "put the above in the top level of the patcher"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 17.0, 292.5, 221.0, 22.0 ],
					"restore" : 					{
						"button[12]" : [ 0.0 ],
						"button[13]" : [ 0.0 ],
						"button[14]" : [ 0.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 240.0, 292.5, 150.0, 60.0 ],
					"text" : "<-- just make sure to have this in every subpatcher where save/recall is required",
					"textjustification" : 2
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 158.5, 91.895264000000111, 63.0, 22.0 ],
					"text" : "closebang"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 635.0, 167.431754666666734, 195.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 421.0, 130.965088000000037, 224.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 635.0, 127.465088000000037, 31.0, 31.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 635.0, 99.965088000000037, 155.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 434.0, 63.395264000000111, 215.0, 25.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 635.0, 63.395264000000111, 31.0, 31.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_enum" : [ "off", "on" ],
...
,
					"patching_rect" : [ 44.0, 163.395264000000111, 90.0, 22.0 ],
...
,
					"patching_rect" : [ 202.700000000000045, 29.395264000000111, 195.799999999999955, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
,
					"patching_rect" : [ 158.5, 127.465088000000037, 240.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "", "", "", "", "" ],
					"patching_rect" : [ 233.5, 64.395264000000111, 107.0, 22.0 ],
					"saved_object_attributes" : 					{
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 379.5, 96.465088000000037, 24.0, 24.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 1015.25, 140.17875699999999, 50.914367999999996, 50.914367999999996 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_enum" : [ "off", "on" ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 335.299999999999955, 96.465088000000037, 24.0, 24.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_enum" : [ "off", "on" ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 405.5, 86.5, 68.0, 42.0 ],
					"presentation" : 1,
					"presentation_linecount" : 2,
					"presentation_rect" : [ 1001.707184000000325, 102.178764000000001, 78.0, 30.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 567.666666666666742, 24.5, 221.0, 22.0 ],
					"restore" : 					{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 158.5, 163.395264000000111, 240.0, 22.0 ],
					"saved_object_attributes" : 					{
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 17.0, 14.5, 829.0, 187.930176000000074 ],
					"proportion" : 0.5
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 389.0, 57.395264000000111, 243.0, 57.395264000000111 ],
					"source" : [ "obj-217", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 309.0, 115.715088000000037, 256.399999999999977, 115.715088000000037 ],
					"source" : [ "obj-224", 3 ]
				}
